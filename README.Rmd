...
BioNetworks an R package for analyzing biological networks using graph theory concepts.
...
## Disclosure
BioNetworks uses functions from the following packages. All rights reserved to the original package authors.
 - WGCNA (doi:10.1186/1471-2105-9-559)
 - STRINGdb (doi:10.1093/nar/gkac1000)
 - igraph (https://igraph.org)
 - brainGraph (https://github.com/cwatson/brainGraph)
 - RCy3 (doi:10.12688/f1000research.20887.3)
 - tmod (doi:10.1093/bioinformatics/btz447)
